...
export default function Modal({ open, title, onClose, children }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-ink/40 p-3 sm:items-center" role="presentation" onMouseDown={onClose}>
      <section role="dialog" aria-modal="true" aria-labelledby="dialog-title" className="max-h-[88vh] w-full max-w-md overflow-auto rounded-[28px] bg-surface p-5 shadow-2xl" onMouseDown={(e) => e.stopPropagation()}>
