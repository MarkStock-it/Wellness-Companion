...
function compactValue(value,depth=0){
 ...
 if(value&&typeof value==='object'&&depth<4)return Object.fromEntries(Object.entries(value).filter(([key])=>!['image','preview','localId','firstName','middleName','lastName','username'].includes(key)).slice(0,30).map(([key,item])=>[key,compactValue(item,depth+1)]));
 return undefined;
}
